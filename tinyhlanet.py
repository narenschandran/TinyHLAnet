...
parser = argparse.ArgumentParser(
    prog="TinyHLAnet", description="Prediction of pHLA-I complex formation"
)
...
if args.file_base is None:
    fbase = os.path.splitext(os.path.splitext(os.path.basename(f))[0])[0] + '.tinyhlanet'
else:
