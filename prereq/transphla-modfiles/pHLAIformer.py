...
parser.add_argument('--output_attention', default = False, action = 'store_true', help = 'Output the mutual influence of peptide and HLA on the binding?')
parser.add_argument('--output_heatmap', default = False, action = 'store_true', help = 'Visualize the mutual influence of peptide and HLA on the binding?')
parser.add_argument('--output_mutation', default = False, action = 'store_true', help = 'Whether to perform mutations with better affinity for each sample?')
...
model_file = os.path.join(SCRIPT_DIR, 'pHLAIformer.pkl')
